...
#define MAX_NETIO_PACKAGE_BUF_LEN (4096<<10)
//最大的长连接session数量
...
enum EPlayerStatus
{
    ...
    EN_PLAYER_STATUS_MULTI_LOGIN = 4,                   // 返回码为40007
    EN_PLAYER_STATUS_BLACK_ACCOUNT = 5,                 // 返回码为40008
    EN_PLAYER_STATUS_ACCOUNT_INFO_INVAILD = 6,          // 返回码为40007
    EN_PLAYER_STATUS_ACCOUNT_NOT_GAME_DATA = 7,         // 返回码为40007
    EN_PLAYER_STATUS_MULTI_EMAIL = 8,                   // 返回码为10000
    EN_PLAYER_STATUS_EMAIL_HAS_MULTI_GAME_DATA = 9,     // 返回码为10000
    EN_PLAYER_STATUS_PRODUCTION_INFO_INVAILD = 10,      // 返回码为10000
...
enum ERetCode
{
    ...
    EN_RET_CODE__PROCESS_ERROR = 501,
    EN_RET_CODE__PARAM_ERROR = 502,
    EN_RET_CODE__SEND_FAIL = 503,
    EN_RET_CODE__TIMEOUT = 504,
    EN_RET_CODE__PACKAGE_LEN_OVERFLOW = 505,
    EN_RET_CODE__PARSE_PACKAGE_ERR = 506,

    EN_RET_CODE__POS_NOT_AVAILABLE = 510,
    EN_RET_CODE__GET_LOCK_FAIL = 511,
